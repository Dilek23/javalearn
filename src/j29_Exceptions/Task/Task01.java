...
public class Task01 {
       ...
       */
        ...
        while (true) {
            try {
                ...
                scan.next();// dummy atadık while döngüsü sonsuz olmaması için
                System.out.println("Hatalı giriş yaptınız.");
            }
        }
        while (true) {
    ...
    private static void orTalamaHesapla(int vizeNotu, int finalNotu) {
         double ortlma=(vizeNotu)*0.4+(finalNotu)*0.6;
        System.out.println("ortlmanız = " + ortlma);
        System.out.println(ortlma>=70?"Tebrikler gectiniz..:)":"Kaldınız...:(");
    }
}
