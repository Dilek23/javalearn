...
public class C05_HashSet {
    ...
    Set :  1) unique(benzersiz tek) elemanlardan olusur, Set'lerin icinde bir eleman sadece bir kere kullanilabilir. mükerrer(duplicate) eleman olmaz.
       ...
       */
        ...
        System.out.println("hs1 = " + hs1);// boş bir hashset eklenen elamanı kafasına göre ekler o yüzden hızlı calısır
        hs1.add("Kevser");
        System.out.println(hs1);//[Ercan, Adem, Kevser, Nur, Yakup, Rukiye]
        hs1.add("Adem");// tekrarlı eleman ekleme
        System.out.println("hs1 = " + hs1); //[Ercan, Adem, Kevser, Nur, Yakup, Rukiye]
      hs1.add(null);
      hs1.add(null);
      hs1.add(null);
        System.out.println("hs1 = " + hs1);// bir tane null ekler
        ...
        System.out.println("hs1.remove(\"\\asıktır\\=\") = " + hs1.remove("asıktır="));// olmayan elmnı silerse false
        System.out.println("hs1.remove(\"\\Asıktır\\=\") = " + hs1.remove("Asıktır="));// olmayan elmnı silerse false
