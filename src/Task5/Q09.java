...
if(db%10==5 && db%9==0){
    System.out.println("able to divide by 9 and by 10 reminder is 5");
}
 */
        System.out.println((db%5==0 && db%8==0)?"able to divide by 5 and 8":(db%10==5 && db%9==0)?
                "able to divide by 9 and by 10 reminder is 5":"Lütfen yeniden deneyiniz");
