...
public class C04_Mathmethods {
     ...
     */
        System.out.println("164 sayısının karekök değeri:"+Math.sqrt(164));
        System.out.println("81'in karekök değeri: " + Math.sqrt(81));
        System.out.println("sayinin mutlak değeri:"+Math.abs(-34));
