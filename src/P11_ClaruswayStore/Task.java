...
​
 name,price,discountRate,amount,brand,screenSize,ram,memory → niteliklerinin aldığı bir constructor create edilmelidir. super class a assign edilmelidir
​
menu() → Override edilmelidir. bu metoda notebook için işlemler bulunmalıdır (Notebook ekleme, listesinin görüntülenmesi, silme, markaya göre filtreleme)
​
addItem() → Override edilmelidir. Bu metodda ürünün ilgili özelliklerinin (name,price,discountRate,amount,brand,screenSize,ram,memory) olduğu ve notebook listesine eklendiği işlemler yapılmalıdır.
​
