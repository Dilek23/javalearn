...
public class C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        DateTimeFormatter dtf=DateTimeFormatter.ofPattern("dd :)MMMM :)YY");// gun ay ve yıl formatı tanımlandı
        System.out.println("dtf.format(ldt) = " + dtf.format(ldt));


        DateTimeFormatter dtf1=DateTimeFormatter.ofPattern("hh:mm:ss a");// saat dakika ve saniye am format
