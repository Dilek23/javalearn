   ...
   todo    Frankfurt girildiyse,
      ...
      "Rota = Köln" yazdırın.
       ...
       case:1  ise
        ...
        System.out.println("!!!DİKKAT!!! max iki kişilik bilet alabilirsiniz!!");
        System.out.println("alacağınız bilet sayısını giriniz :");

        int kisiSay = scan.nextInt();
        int Frankfurtbilet = 15;
        int Kölnbilet = 20;
        int ödemeF = kisiSay * Frankfurtbilet;
        int ödemeK = kisiSay * Kölnbilet;
        ...
        if (kisiSay <= 2) {
            ...
            switch (hedef) {
                ...
                case "FRANKFURT": {
                    ...
                    System.out.println("frankfurt yürüyen uçak turizme hoş geldiniz.");
                    System.out.println("ücretiniz :" + kisiSay + " " + "kişi için" + (kisiSay * Frankfurtbilet) + " " + "€ dur.");
                    System.out.println("işleme devam etmek için: (1) onaylamıyorsanız: (2) yazınız");

                    int secim = scan.nextInt();

                    switch (secim) {
                        case 1:
                            System.out.println("FRANKFURT" + " " + kisiSay + " " + "kişi" + " " + (kisiSay * Frankfurtbilet) + "€ dur");
                            System.out.println("ödeme için bakiye giriniz");
                            double ödeme = scan.nextDouble();
                            if (ödeme > (ödemeF)) {
                                System.out.println("para üstü = " + ((ödeme) - (ödemeF)) + "€");


                            } else if (ödeme < ödemeF) {
                                System.out.println("eksik ücret=" + ((ödeme) - (ödemeF)) + "€");

                            } else if (ödeme == ödemeF) {
                                System.out.println("ödeme tamamlanmıştır");

                            } else System.out.println("hata!!!");

                            break;
                        case 2:
                            System.out.println("işleminiz sonlandırılmıştır.");
                            break;
                        default:
                ...
                case "KÖLN": {
                    ...
                    System.out.println("Köln koşan uçak turizme hoş geldiniz.");
                    System.out.println("ücretiniz :" + kisiSay + " " + "kişi için" + (kisiSay * Kölnbilet) + " " + "€ dur.");
                    System.out.println("işleme devam etmek için: (1) onaylamıyorsanız: (2) yazınız");
                    int secim = scan.nextInt();

                    switch (secim) {
                        case 1:
                            System.out.println("KÖLN" + " " + kisiSay + " " + "kişi" + " " + (kisiSay * Kölnbilet) + "€ dur");
                            System.out.println("ödeme için bakiye giriniz");
                            double ödeme = scan.nextDouble();
                            if (ödeme > (ödemeF)) {
                                System.out.println("para üstü = " + ((ödeme) - (ödemeF)) + "€");
        ...
        } else System.out.println("yanlış sayı!!!");
