...
/*
	 ...
	 */
        ...
        System.out.println("\n***  ");
        printelStructrudcift(sayi);
        System.out.println("\n***  ");
        printelFunctional3(sayi);
    }//main sonu
  //TAsk->"Structured programing: amelee kod kullanarak list elemanlarını aynı satırda aralarında boşluk olcak sekilde printet
  public static void printelStructrud(List<Integer>sayi){
        for (Integer w:sayi){
            System.out.print(w+" ");
        }
  }

  //TAsk->"Functional programing: amlee kod kullanarak list elemanlarını aynı satırda aralarında boşluk olcak sekilde printet
  public static void printelFunctional(List<Integer>sayi) {

sayi.
        stream().//List elemanları yukarıdan asagı akışa alır
  ...
  public static void printelFunctional1(List<Integer>sayi) {
      ...
      sayi.stream().//List elemanları yukarıdan asagı akışa alır
              forEach((System.out::print));//Metod referans->System out ypısında pr,nt metod call edildi
                                          //Method kaynagı::Method meth referans
  }
  public static void yazdir(int a){// Normal metod tek aksiyonlu-> seed metod (tohum)->refere edilecek method
      System.out.print(a+" ");
    ...
    public static void printelFunctional2(List<Integer>sayi) {
        ...
        sayi.stream().//List elemanları yukarıdan asagı akışa alır
                forEach((C01_LambdaExpression::yazdir));//Metod referans->System out ypısında pr,nt metod call edildi
        //Method kaynagı::Method meth referans
    }
    ...
    public static void printelStructrudcift(List<Integer>sayi){// amele method
        for (Integer w:sayi){
            if(w%2==0){
                System.out.print( w+" ");
            }
    ...
    public static boolean tekMİi(int X) {//Refere edilecek method
        return X % 2 == 1;
