...
public class C1_JavaMathClassMethods {
    public static void main(String[] args) {
     ...
     // random metoduyla rastgele deger üretme;Deger aralıgını yükseltmek ,çarpı *100
     ...
     // int ddgerler uretme
       ...
       int x= (int) (Math.random()*max);
        ...
        System.out.printf(x<y?"x min":"y min");
        // Java Math.random class
        for (int i = 0; i <10 ; i++) {
            System.out.println((i+1)+" .sayı"+Math.random());
...
// Random Class
       ...
       int randomSayi= rand.nextInt(100);
            System.out.println("i = " +randomSayi);
        }
